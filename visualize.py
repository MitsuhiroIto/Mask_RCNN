...
def display_images(images, titles=None, cols=4, cmap=None, norm=None,
    ...
    for image, title in zip(images, titles):
        ...
        plt.axis('off')
        image = plt.imshow(image.astype(np.uint8), cmap=cmap,
...
def display_instances(image, boxes, masks, class_ids, class_names,
                      scores=None, title="",
                      figsize=(16, 16), ax=None, filename = ""):
    """
    ...
    for i in range(N):
        ...
        #scipy.misc.imsave("test{}.jpg".format(i),masked_image)
    ...
    #plt.savefig(filename + "_mask.jpg")
    ROOT_DIR = os.getcwd()
    filename = filename.rsplit('.', 1)[0]   + "_mask.png" 
    plt.savefig( ROOT_DIR + "/" + filename)
    #import ipdb; ipdb.set_trace()
    #scipy.misc.imsave("test.jpg",ax.imshow(masked_image.astype(np.uint8)))
    #dreturn(image)
